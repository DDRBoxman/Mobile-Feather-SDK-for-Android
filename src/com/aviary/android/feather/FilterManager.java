...
public final class FilterManager implements OnPreviewListener, OnApplyResultListener, EffectContext, OnErrorListener,
	...
	private int[] mOriginalBitmapSize = new int[2];
	...
	/**
	 * Return the original size of the image being edited
	 * 
	 * @param size
	 *           - an integer array of 2 elements. it will be filled with the width and height of the loaded image
	 */
	public void getOriginalBitmapSize( int[] size ) {
		size[0] = mOriginalBitmapSize[0];
		size[1] = mOriginalBitmapSize[1];
	}
	...
	public void onActivate( final Bitmap bitmap, int[] originalSize ) {
		...
		mBitmap = bitmap;
		mOriginalBitmapSize = originalSize;
		mChanged = false;
